...
### User
This table stores all patient-related data. It is linked to the therapist table through a many-to-many relationship, as each patient can have multiple therapists, and each therapist can have multiple patients. This table also stores the preferences of the user in three columns: dark_mode, large_text, and language. These all accept boolean values.
