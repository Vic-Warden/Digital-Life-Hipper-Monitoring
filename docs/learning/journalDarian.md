...
#### Learned:
by doing the other user story about how to implement powerbi in a web application. I learned that it is possible to make an iframe which can be used in HTML to showcase the powerbi. 

the steps to take are found and are as follows:
...
I also have a step by step guide to make these color changes in PowerBi these are as follows:
1. **Select the Visual**
   - Click on the graph/visual you want to customize in your Power BI report.

2. **Open the Format Pane**
   - In the Visualizations pane, click the **Format** (paint roller) icon.

3. **Find Data Colors**
   - Expand the **Data colors** section.

4. **Change Colors**
   - You will see a list of series or categories in your graph.
...
# How to Use Live Preview in Visual Studio Code

This is a simple guide for previewing your HTML files in Visual Studio Code using the **Live Preview** extension.
...
### 3. Open an HTML File
- Open a folder or create a new file with `.html` extension.
- Example: `index.html`

### 4. Start the Preview
- Click the **Go Live** button in the bottom-right corner.
- Or press `Ctrl+Shift+P` and type `Live Preview: Show Preview`.

### 5. See Your Page
- A new tab or window will open showing your HTML page.
- Any changes you make will update automatically in the preview.

---

## Tips
- Save your file before previewing to make sure everything loads.
- You can preview CSS and JavaScript changes too.